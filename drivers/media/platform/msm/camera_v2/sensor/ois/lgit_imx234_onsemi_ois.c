...
const struct STFILRAM	CsFilRam_C012[FILRAMTAB]	= {
	...
	{0x1218, 0x3F7C9C40},		/*3F7C9C40,1218,PKF,300Hz,-8dB,5,fs/1,invert=0*/
	{0x1219, 0xBFF98F40},		/*BFF98F40,1219,PKF,300Hz,-8dB,5,fs/1,invert=0*/
	{0x121A, 0x3FF98F40},		/*3FF98F40,121A,PKF,300Hz,-8dB,5,fs/1,invert=0*/
	{0x121B, 0x3F782040},		/*3F782040,121B,PKF,300Hz,-8dB,5,fs/1,invert=0*/
	{0x121C, 0xBF74BC40},		/*BF74BC40,121C,PKF,300Hz,-8dB,5,fs/1,invert=0*/
...
// History			: First edition							2014.12.04 T.Tokoro
//********************************************************************************
void PwmCareerSet_old(uint8_t ucMode)
{
	//IOP0 = Stlove(HSYNC)
	//IOP2 = ExClk
	// PWM Clock Frequency = 24 MHz
